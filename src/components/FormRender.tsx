      ...
      <FormControl>
        <div className="relative">
          <input
            ...
            className="bg-transparent border-[#0000003B] border-[1px] text-[#0000003B] rounded-lg h-12 px-4 w-full focus:outline-none focus:ring-2 focus:ring-[#0000003B] focus:border-transparent placeholder:text-[#646464]"
          />
