    ...
    return (
        <div className="flex h-screen">
            <div className=" w-2/3 flex flex-col items-center justify-center px-[16rem] gap-10">
                ...
                <h2 className='text-[#4D4D4D] text-3xl font-bold'>Account created Successfully</h2>
                <p className='font-normal text-2xl text-center'>Kindly login to update your business information</p>
