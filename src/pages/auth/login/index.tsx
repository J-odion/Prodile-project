...
const Login = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen">
      {/* <div className="absolute top-0 left-8 h-full w-1/4">
        <Image
      ...
      <div className="absolute top-0 left-8 h-full w-1/2">
        <Image
          src="/images/Saly-drive.svg"
          alt="Agricultural Illustration Right"
          layout="fill"
          objectFit="contain"
        />
      </div>
      <Card className="mx-auto max-w-sm z-10 bg-transparent">
        <CardHeader>
